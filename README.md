...
> Check JS bundle size and limits

[![PyPI version](https://badge.fury.io/py/bundle-size.svg)](https://pypi.org/project/bundle-size/)
...
```bash
pip install bundle-size
```

## Quick Start

```python
from bundle_size import size

# Basic usage
result = size("your input here")
print(result)
```
